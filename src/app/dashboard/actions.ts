...
async function initializeAllTables() {
    ...
    const commands = [
        ...
        `ALTER TABLE public.${BOOKS_TABLE} ENABLE ROW LEVEL SECURITY;`,
        `DROP POLICY IF EXISTS "Allow public read access" ON public.${BOOKS_TABLE};`,
        `CREATE POLICY "Allow public read access" ON public.${BOOKS_TABLE} FOR SELECT USING (true);`,
        `DROP POLICY IF EXISTS "Allow public write access" ON public.${BOOKS_TABLE};`,
        `CREATE POLICY "Allow public write access" ON public.${BOOKS_TABLE} FOR INSERT WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public update access" ON public.${BOOKS_TABLE};`,
        `CREATE POLICY "Allow public update access" ON public.${BOOKS_TABLE} FOR UPDATE USING (true) WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public delete access" ON public.${BOOKS_TABLE};`,
        `CREATE POLICY "Allow public delete access" ON public.${BOOKS_TABLE} FOR DELETE USING (true);`,
        ...
        `DROP POLICY IF EXISTS "Allow public read access" ON public.${EXPANDED_WORDS_TABLE};`,
        `CREATE POLICY "Allow public read access" ON public.${EXPANDED_WORDS_TABLE} FOR SELECT USING (true);`,
        `DROP POLICY IF EXISTS "Allow public write access" ON public.${EXPANDED_WORDS_TABLE};`,
        `CREATE POLICY "Allow public write access" ON public.${EXPANDED_WORDS_TABLE} FOR INSERT WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public update access" ON public.${EXPANDED_WORDS_TABLE};`,
        `CREATE POLICY "Allow public update access" ON public.${EXPANDED_WORDS_TABLE} FOR UPDATE USING (true) WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public delete access" ON public.${EXPANDED_WORDS_TABLE};`,
        ...
        `ALTER TABLE public.${NOTES_TABLE} ADD COLUMN IF NOT EXISTS editor_type text DEFAULT 'default'::text;`,
        `ALTER TABLE public.${NOTES_TABLE} ENABLE ROW LEVEL SECURITY;`,
        `DROP POLICY IF EXISTS "Allow public read access" ON public.${NOTES_TABLE};`,
        `CREATE POLICY "Allow public read access" ON public.${NOTES_TABLE} FOR SELECT USING (true);`,
        `DROP POLICY IF EXISTS "Allow public write access" ON public.${NOTES_TABLE};`,
        `CREATE POLICY "Allow public write access" ON public.${NOTES_TABLE} FOR INSERT WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public update access" ON public.${NOTES_TABLE};`,
        `CREATE POLICY "Allow public update access" ON public.${NOTES_TABLE} FOR UPDATE USING (true) WITH CHECK (true);`,
        `DROP POLICY IF EXISTS "Allow public delete access" ON public.${NOTES_TABLE};`,
    ...
    for (const command of commands) {
        ...
        if (error) {
            ...
            if (!error.message.includes('already exists') && !error.message.includes('must be owner')) {
