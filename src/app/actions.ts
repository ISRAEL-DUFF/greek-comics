...
async function initializeDatabase() {
    if (!supabase) {
      console.log("Supabase not configured. Skipping database initialization for stories.");
      return;
    };
    ...
    if (error) {
      console.error('Error during comic stories database initialization:', error.message);
    } else {
      console.log('Comic stories database initialization check complete.');
    }
}
